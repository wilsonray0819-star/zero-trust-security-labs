...
This lab enforces device trust as a prerequisite for access.
...
## Outcome
This lab demonstrates the ability to manage and secure endpoints at scale, enforce Zero Trust access based on device health, and integrate endpoint security with identity-based access controls.
...
## Notes
Screenshots and validation evidence are provided in the screenshots directory.
